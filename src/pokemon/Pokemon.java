...
//		this.tipos = new Tipo[2];
    ...
    public void ponerEstado() {
        ...
        if (estaPersistente && this.estado.getPersistente() != EstadoPersistente.NORMAL) {
            System.out.println("No se puede cambiar el estado de " + this.nombre + " dado que esta " + this.estado.getPersistente().getMensaje());
            return;
        }
        ...
        for (Movimiento movimiento : movimientos) {
            if (this.estado.getTemporal() != null || this.estado.getOtros() == OtrosEstados.DEBILITADO) {
                ...
                if (estadoMovimiento == EstadoPersistente.PARALIZADO || estadoMovimiento == EstadoPersistente.QUEMADO || estadoMovimiento == EstadoPersistente.ENVENENADO || estadoMovimiento == EstadoPersistente.GRAVEMENTE_ENVENENADO || estadoMovimiento == EstadoPersistente.CONGELADO) {
            ...
            if (this.estado.getPersistente() != null || this.estado.getOtros() == OtrosEstados.DEBILITADO) {
                ...
                if (estadoMovimiento2 == EstadoTemporal.CONFUSO || estadoMovimiento2 == EstadoTemporal.DORMIDO || estadoMovimiento2 == EstadoTemporal.AMEDRENTADO || estadoMovimiento2 == EstadoTemporal.DRENADORAS) {
    ...
    public void subirNivel() {
        ...
        System.out.println("Le queda a " + this.nombre + ", " + (experienciaRequerida - this.experienciaActual) + " puntos de experiencia para subir de nivel.");
...
//		this.velocidadMaxima = (int) (Math.random() * (31 - 5)) + 5;
    ...
    private int formulaDanio(int indiceMovimiento, Pokemon rival) {
        ...
        Eficacias.EficaciasPokemon[] ef = new Eficacias.EficaciasPokemon[]{
                Eficacias.EficaciasPokemon.ES_POCO_EFICAZ, Eficacias.EficaciasPokemon.NO_MUY_ES_EFICAZ,
                Eficacias.EficaciasPokemon.ES_NEUTRO, Eficacias.EficaciasPokemon.ES_EFICAZ, Eficacias.EficaciasPokemon.ES_MUY_EFICAZ};
    ...
    public String toString() {
        return "Pokemon [nombre=" + nombre + ", nivel=" + nivel + " ,tipo=" + Arrays.toString(getTipo()) + ", vitalidadActual=" + vitalidadActual + ", vitalidadMaxima=" + vitalidadMaxima + ", ataque=" + ataqueMaxima + ", defensa=" + defensaMaxima + ", ataqueEspecial=" + ataqueEspecialMaxima + ", defensaEspecial=" + defensaEspecialMaxima + ", velocidad=" + velocidadMaxima + ", estaminaActual=" + estaminaActual + ", estaminaMaxima=" + estaminaMaxima + ", fertilidad=" + fertilidad + ", sexo=" + sexo + "]";
    }
